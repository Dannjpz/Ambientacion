DROP PROCEDURE IF EXISTS "informix".sp_consulta_saldos_general_fixed(CHAR(3), CHAR(20));


CREATE PROCEDURE "informix".sp_consulta_saldos_general_fixed(pEmpresa CHAR(3), pNumCredito CHAR(20))
RETURNING  
    ...
    -----------------------------------------------------------------------------------------------------------
    -- Fecha: 12/10/2009                                                                                     --
    -- Autor: Roque Enrique Solis CampaÃÂÃÂ±a                                                                    --
    ...
    -- Modificacion: Se modifica mÃÂÃÂ©todo para calcular el IVA moratorio en prÃÂÃÂ©stamos personales y             --
    --				 reestructuras                                                                           --
    -----------------------------------------------------------------------------------------------------------
    ...
    SET DEBUG FILE TO "/resplogifx/repaclaraciones/sp_sp_consulta_saldos_general.out";
    TRACE ON;
	...
	ELSE
        ...
        -- SELECT CAST(SUM(NVL(monto,0)) AS DECIMAL(14,2))
        -- INTO dMontoSBC
