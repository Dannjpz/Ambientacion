DROP PROCEDURE IF EXISTS "informix".cargo_ref_cel --33 PARAMETROS
      (              CHAR(16),
                    CHAR(4),
                     CHAR(8),
                     CHAR(4),
               ...
               CHAR(40),
                  CHAR(1),
                   CHAR(1),  -- jom Se agrega para identificar el tipo de comision   (F=No aplica,V=Aplica)
              CHAR(4),
             CHAR(4),
                CHAR(16),
            INTEGER,
...
--TRACE ON;
	...
	--SET DEBUG FILE TO "/resplogifx/repaclaraciones/cargo_ref_cel2.out";
	--TRACE ON;
