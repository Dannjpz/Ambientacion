DROP PROCEDURE IF EXISTS "informix".sp_registra_evento (
					 char(1),  char(10), char(12),  char(20),
					 char(20),  char(16), char(1),  char(30), 
					 char(30),  char(30),  char (30), 
					 char(150),  char(100),  char(60),  char(60), 
					 char(15),  char(100),  char(100),  char(10), 
					 money (16,2),  money (16,2),
					 money (16,2),  money (16,2),  money (16,2), 
					 datetime year to fraction(3),  datetime year to fraction(3)
				    );
...
--	TRACE ON;
	...
	--SET DEBUG FILE TO "/resplogifx/Dann/sp_registra_evento_3.out";
	--TRACE ON;
