...
END PROCEDURE
DOCUMENT
'DESCRIPCION: Se modifica para contemplar movimientos diferidos, en el proceso de realizar el cargo al cr�dito', 
'AUTOR: Jes�s Aguilar ',
'FECHA: 08 FEBRERO 2012',
'BD: BDICRED',
'DESCRIPCION MODIFICACION: Se cambia el proceso para que guarde la transaccion 6837 en los retenidos de los intereses en lugar de la transaccion de disposici�n',
'MODIFICO: Mohamed Carre�n',
