DROP PROCEDURE IF EXISTS "informix".sp_registra_evento_bpi (
					 char(1),  char(10),  char(20),
...
BEGIN
   ...
   END EXCEPTION;
	...
	--TRACE ON;
	--SET DEBUG FILE TO "/resplogifx/repaclaraciones/sp_registra_evento_bpi.out";
	--TRACE ON;
 ...
 IF pIdPlantilla <> '' or pIdPlantilla is NOT null  then
  --Llama al nuevo sp_registra_evento que contiene un parametro más (IdPlantilla)
